 ...
 * generated in the notitions package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddNote_QNAME = new QName("http://notews/", "addNote");
    private final static QName _GetNotes_QNAME = new QName("http://notews/", "getNotes");
    private final static QName _GetNotesResponse_QNAME = new QName("http://notews/", "getNotesResponse");
    private final static QName _AddNoteResponse_QNAME = new QName("http://notews/", "addNoteResponse");
    private final static QName _RemoveNoteResponse_QNAME = new QName("http://notews/", "removeNoteResponse");
    private final static QName _RemoveNote_QNAME = new QName("http://notews/", "removeNote");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: notitions
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://notews/", name = "getNotes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://notews/", name = "getNotesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://notews/", name = "removeNoteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://notews/", name = "removeNote")
